package com.example.GeradorDeJogador.utils;
...
public class SoccerPlayer {
    ...
    public SoccerPlayer(String firstName,
        ...
        setLastName(StringUtils.capitalize(lastName));
        setPosition(StringUtils.capitalize(position));
        setTeam(StringUtils.capitalize(team));
        setAge(age);
    }
